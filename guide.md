...
By default the Flight server is generated as a web app that will be deployed in a WebSphere Liberty container. If you prefer to deploy the server as a stand-alone application, specify the `-PstandaloneFlightSvc=true` option:
