...
/**
 * Localized labels for a data source using JDBC.
 */
@SuppressWarnings({ "PMD.AvoidDollarSigns", "PMD.ClassNamingConventions" })
public enum $_CONNNAMEPREFIX_$Labels implements ResourceBundleHelper.MessageFormatter<$_CONNNAMEPREFIX_$Labels>
{
    /**
    ...
    private static final ResourceBundleHelper<$_CONNNAMEPREFIX_$Labels> BUNDLE = new ResourceBundleHelper<>($_CONNNAMEPREFIX_$Labels.class);
