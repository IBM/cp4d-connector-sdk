...
/**
 * Localized labels for generic JDBC.
 */
public enum GenericJdbcLabels implements ResourceBundleHelper.MessageFormatter<GenericJdbcLabels>
{
    /**
    ...
    /**
     * Label for connection property jdbc_url.
     */
    CONNECTION_JDBC_URL_LABEL,

    /**
     * Description for connection property jdbc_url.
     */
    CONNECTION_JDBC_URL_DESCRIPTION,

    /**
     * Label for connection property jdbc_properties.
     */
    CONNECTION_JDBC_PROPERTIES_LABEL,

    /**
     * Description for connection property jdbc_properties.
     */
    CONNECTION_JDBC_PROPERTIES_DESCRIPTION,
    ...
    /**
     * Label for connection property row_limit_support.
     */
    CONNECTION_ROW_LIMIT_SUPPORT_LABEL,

    /**
     * Description for connection property row_limit_support.
     */
    CONNECTION_ROW_LIMIT_SUPPORT_DESCRIPTION,

    /**
     * Label for connection property row_limit_support value none.
     */
    CONNECTION_ROW_LIMIT_SUPPORT_VALUE_NONE_LABEL,

    /**
     * Label for connection property row_limit_support value prefix.
     */
    CONNECTION_ROW_LIMIT_SUPPORT_VALUE_PREFIX_LABEL,

    /**
     * Label for connection property row_limit_support value suffix.
     */
    CONNECTION_ROW_LIMIT_SUPPORT_VALUE_SUFFIX_LABEL,

    /**
     * Label for connection property row_limit_prefix.
     */
    CONNECTION_ROW_LIMIT_PREFIX_LABEL,

    /**
     * Description for connection property row_limit_prefix.
     */
    CONNECTION_ROW_LIMIT_PREFIX_DESCRIPTION,

    /**
     * Label for connection property row_limit_suffix.
     */
    CONNECTION_ROW_LIMIT_SUFFIX_LABEL,

    /**
     * Description for connection property row_limit_suffix.
     */
    CONNECTION_ROW_LIMIT_SUFFIX_DESCRIPTION,

    /**
     * Label for connection property ssl_certificate.
     */
    CONNECTION_SSL_CERTIFICATE_LABEL,

    /**
     * Description for connection property ssl_certificate.
     */
    CONNECTION_SSL_CERTIFICATE_DESCRIPTION,
    ...
    private static final ResourceBundleHelper<GenericJdbcLabels> BUNDLE = new ResourceBundleHelper<>(GenericJdbcLabels.class);
